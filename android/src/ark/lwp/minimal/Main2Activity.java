    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
           ...
           // if(getArguments().getInt(ARG_SECTION_NUMBER)==1) {
                ...
                final ImageView imageView = (ImageView) rootView.findViewById(R.id.particle_color_image);
                SeekBar size_bar=(SeekBar)rootView.findViewById(R.id.seekBar2);
                SeekBar velocity_bar=(SeekBar)rootView.findViewById(R.id.seekBar3);

                velocity_bar.setMax(2000);
                size_bar.setProgress(pref.get_size());
                velocity_bar.setProgress(pref.get_velocity());


                velocity_bar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
                    @Override
                    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                        pref.set_velocity(progress);
                    }
            ...
            imageView.setBackgroundColor(com.badlogic.gdx.graphics.Color.valueOf(pref.get_color()).toIntBits());
